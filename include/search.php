...
<button type="button" onclick="(function(){function g(i){return document.getElementById(i).value;};d='<?php if(isset($word)){echo $word;}?>';q=g('search');q=(q=='')?d:q;window.open('http://www.google.com/search?q='+q+'&amp;tbs=dfn:1&amp;defl='+g('language').split('/')[2]);})();">Google Dict</button>
</form>
</div>
